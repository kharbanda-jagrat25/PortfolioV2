...
const GetInTouch = ({ itemRef }) => {
  ...
  const contactOptions = [
    ...
    {
      name: "Email",
      value: "kharbanda.jagrat25@gmail.com",
      ...
      <div className="bg-[#1d1d1d] m-5 w-[100%] p-10">
        <div className="flex flex-wrap ">
          <div className="basis-1/4 mr-2">
            ...
            <h6 className="text-teal-500 font-light">Let's Discuss.</h6>
            <div className="mt-10">
              {contactOptions.map(({ icon, name, value }) => (
                <div key={name} className="flex items-center mb-4">
                  ...
                  <span className="ml-4 font-normal text-sm max-w-[90%] text-ellipsis overflow-hidden hover:text-white text-teal-500">
                    {value}
                  </span>
                </div>
              ))}
          ...
          <form className="w-full flex-1" onSubmit={handleSubmit}>
            ...
            {message && (
              <div className="flex items-center mt-3">
                <img
                  className="w-6 h-6 mr-2 bg-teal-500 rounded-full p-1"
