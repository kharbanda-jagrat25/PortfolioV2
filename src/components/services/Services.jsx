    ...
    >
      ...
      <div className="flex flex-wrap mt-8 mx-16 xl:mx-48 lg:mx-48 md:mx-8 sm:mx-48 2xl:mx-48 justify-between">
        {serviceList?.map(({ id, icon, label, description }) => (
          <div
            key={id}
            className="group bg-neutral-800 min-h-[220px] duration-500 transition-all text-gray-300 py-3 px-5 rounded-md border-teal-400 border w-full sm:w-[48%] md:w-[30%] hover:bg-teal-400 hover:text-black mb-4"
          >
