        ...
        <div className="flex flex-wrap">
          {skills
            ...
            .map((skill) => (
              <div
              key={skill.name}
                className={`text-sm duration-500 transition-all border-teal-500 border-2 bg-neutral-800 flex items-center justify-center px-8 py-2 m-3 text-white hover:text-black hover:bg-teal-500 ${getBorderRadius(
                  skill
                )}`}
              >
                {skill.name}
