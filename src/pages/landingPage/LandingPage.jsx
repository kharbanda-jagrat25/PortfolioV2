...
export const LandingPage = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      link: "https://www.linkedin.com/in/kharbanda-jagrat-jk25/",
    },
    {
      name: "Twitter",
      icon: "assets/icons/twitter.svg",
      link: "https://twitter.com/Kharbanda_cool",
    },
    {
      name: "Github",
      icon: "assets/icons/github.svg",
      link: "https://github.com/kharbanda-jagrat25",
    },
  ];
  ...
  const navigateToSocialLinks = ({ name, link }) => {
    if (name === "Gmail")
      return (window.location = "mailto:kharbanda.jagrat25@gmail.com");
    ...
    <>
      <div className="pb-10">
        ...
        <div className="h-full flex items-center flex-col justify-center text-white mt-10 mb-10">
          <Heading mainHeading="Hi, I am" subHeading="Jagrat Kharbanda" />
        ...
        <div className="flex items-center justify-center">
          {socialLinks?.map(({ name, icon, link }) => (
            <div
              key={name}
              className="flex items-center justify-center rounded-full bg-white w-10 h-10 mr-5 hover:bg-teal-500 transition-all duration-500 cursor-pointer"
